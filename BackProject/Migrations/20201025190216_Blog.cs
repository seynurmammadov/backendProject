    ...
    public partial class Blog : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogModerators", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlogModerators_Blogs_BlogId",
                        column: x => x.BlogId,
                        principalTable: "Blogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogModerators_AspNetUsers_ModeratorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogModerators_BlogId",
                table: "BlogModerators",
                column: "BlogId");

            migrationBuilder.CreateIndex(
                name: "IX_BlogModerators_ModeratorId",
                table: "BlogModerators",
                column: "ModeratorId");
        }
